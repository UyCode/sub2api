...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	geminiMessagesCompatService := service.NewGeminiMessagesCompatService(accountRepository, groupRepository, gatewayCache, schedulerSnapshotService, geminiTokenProvider, rateLimitService, httpUpstream, antigravityGatewayService, settingService, configConfig)
	...
	concurrencyTestRepository := repository.NewConcurrencyTestRepository(db)
	concurrencyTestService := service.NewConcurrencyTestService(concurrencyTestRepository, accountRepository, secretEncryptor, configConfig)
	concurrencyTestHandler := admin.NewConcurrencyTestHandler(concurrencyTestService)
	...
	adminHandlers := handler.ProvideAdminHandlers(dashboardHandler, adminUserHandler, groupHandler, accountHandler, adminAnnouncementHandler, dataManagementHandler, backupHandler, oAuthHandler, openAIOAuthHandler, geminiOAuthHandler, antigravityOAuthHandler, proxyHandler, adminRedeemHandler, promoHandler, settingHandler, opsHandler, systemHandler, adminSubscriptionHandler, adminUsageHandler, userAttributeHandler, errorPassthroughHandler, tlsFingerprintProfileHandler, adminAPIKeyHandler, scheduledTestHandler, channelHandler, channelMonitorHandler, channelMonitorRequestTemplateHandler, concurrencyTestHandler, contentModerationHandler, paymentHandler, affiliateHandler)
