export default {
  ...
  admin: {
    ...
    concurrencyTests: {
      ...
      description: 'Send concurrent requests to upstream accounts or a custom endpoint to measure capacity, timeouts, and latency distribution',
      searchPlaceholder: 'Search test name...',
      createButton: 'New Test',
      createTitle: 'Create Concurrency Test',
      editTitle: 'Edit Concurrency Test',
      emptyTitle: 'No concurrency tests yet',
      emptyDescription: 'Create a test configuration to stress an upstream account or custom endpoint.',
      loadError: 'Failed to load concurrency tests',
      accountsLoadError: 'Failed to load accounts',
      saveError: 'Failed to save concurrency test',
      createSuccess: 'Concurrency test created',
      updateSuccess: 'Concurrency test updated',
      deleteSuccess: 'Concurrency test deleted',
      deleteError: 'Failed to delete concurrency test',
      deleteConfirm: 'Delete concurrency test "{name}"? Its saved runs and logs will also be removed.',
      run: 'Run',
      running: 'Running',
      runComplete: 'Concurrency test completed',
      runFailed: 'Concurrency test failed',
      latestResult: 'Latest Result',
      noRunsYet: 'No runs yet',
      history: 'Run History',
      historyFor: 'Run History: {name}',
      resultTitle: 'Concurrency Test Result',
      viewLogs: 'View Logs',
      loadRunsError: 'Failed to load run history',
      loadLogsError: 'Failed to load run logs',
      customTarget: 'Custom endpoint',
      accountDefaultEndpoint: 'Account platform default',
      accountCount: '{count} account(s)',
      accountSelection: 'Account Selection',
      noAccountsLoaded: 'No accounts loaded',
      endpointPlaceholder: 'Optional for account mode; required for custom targets',
      templateHint: 'Template variables: request_index, account_id, timestamp. Use them in the body by wrapping the variable name with double braces. OpenAI image edits convert image_base64 to multipart; Gemini image edits use inline_data.',
      invalidJson: 'Invalid JSON',
      jsonObjectOnly: 'Must be a JSON object',
      runSummary: '{total} requests, {success} succeeded, {failed} failed',
      fields: {
        name: 'Test Name',
        description: 'Description',
        mode: 'Scenario',
      ...
      modes: {
        responses: 'Standard /v1/responses',
        openaiImageGenerations: 'OpenAI Image Generation',
        openaiImageEdits: 'OpenAI Image Edit',
        geminiImageGenerations: 'Gemini Image Generation',
        geminiImageEdits: 'Gemini Image Edit'
      },
      metrics: {
